...
export function FloatingWhatsApp() {
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-20 sm:bottom-6 right-4 sm:right-6 z-[100] flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 bg-green-500 text-white rounded-full shadow-2xl hover:bg-green-600 hover:scale-110 transition-all duration-300"
