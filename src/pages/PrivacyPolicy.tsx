...
export default function PrivacyPolicy() {
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col font-sans selection:bg-blue-500/30">
      <Helmet>
        <title>Privacy Policy - KA Degree</title>
      </Helmet>
      <Navbar />
      ...
      <main className="flex-grow pt-32 pb-24">
        <div className="container mx-auto px-4 md:px-6 max-w-4xl">
           ...
           <div className="text-slate-300 leading-relaxed space-y-6">
             <p><strong>KA Degree</strong> (“us”, “we”, or “our”) operates the <strong>www.kadegree.in</strong> website (the “Service”).</p>
             <p>This page informs you of our policies regarding the collection, use and disclosure of Personal Information when you use our Service.</p>
             <p>We will not use or share your information with anyone except as described in this Privacy Policy. We use your Personal Information for providing and improving the Service. By using the Service, you agree to the collection and use of information in accordance with this policy. Unless otherwise defined in this Privacy Policy, terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, accessible at www.kadegree.in.</p>
             ...
             <h2 className="text-2xl font-bold text-white mt-8 mb-4">Log Data</h2>
             ...
             <p>If you have any questions about this Privacy Policy, please contact us at admin@kadegree.com.</p>
           </div>
        </div>
      </main>
