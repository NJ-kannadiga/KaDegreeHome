...
export default function TestimonialSection() {
    return (
        <div id="testimonials" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Student Success Stories" text2="Don't just take our word for it" text3="Hear from our alumni who have successfully transitioned into top technology roles after completing our programs." />
